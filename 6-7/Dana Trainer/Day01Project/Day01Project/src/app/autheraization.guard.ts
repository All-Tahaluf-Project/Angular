...
export class AutheraizationGuard implements CanActivate {
  ...
  canActivate(
    ...
    // the idea of the guard is if the user has autherize of the spicefic page , it will return true and if not it will retuen false
    //return true --> you can go  to this route 
    //false --->you cannot go to the route
    ...
    state: RouterStateSnapshot): Observable<boolean | UrlTree> | Promise<boolean | UrlTree> | boolean | UrlTree {
      ...
      this.toastr.warning('you are not autheraized');
